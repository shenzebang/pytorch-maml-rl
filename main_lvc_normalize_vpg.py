...
from maml_rl.metalearner_lvc_normalize_vpg import MetaLearnerLVCNormalizeVPG
...
def main(args):
    ...
    metalearner = MetaLearnerLVCNormalizeVPG(sampler, policy, baseline, gamma=args.gamma,
