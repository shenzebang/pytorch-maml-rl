...
from maml_rl.metalearner_lvc_normalize_vpg_test import MetaLearnerLVCNormalizeVPGTest
...
def main(args):
    ...
    metalearner = MetaLearnerLVCNormalizeVPGTest(sampler, policy, baseline, gamma=args.gamma,
