...
from maml_rl.metalearner_lvc_normalize_ppo import MetaLearnerLVCNormalizePPO
...
def main(args):
    ...
    metalearner = MetaLearnerLVCNormalizePPO(sampler, policy, baseline, gamma=args.gamma,
