...
from maml_rl.metalearner_lvc_normalize_sgd import MetaLearnerLVCNormalizeSGD
...
def main(args):
    ...
    metalearner = MetaLearnerLVCNormalizeSGD(sampler, policy, baseline, gamma=args.gamma,
